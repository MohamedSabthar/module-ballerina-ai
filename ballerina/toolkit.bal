...
public isolated function getPermitedMcpToolConfigs(mcp:StreamableHttpClient mcpClient, mcp:Implementation info,
    ...
    return from mcp:ToolDefinition tool in listTools.tools
        ...
        select {
            name: tool.name,
            description: tool.description ?: "",
            parameters: (<map<json>>tool.inputSchema).cloneReadOnly(), // this will be fix in mcp 1.0.0
